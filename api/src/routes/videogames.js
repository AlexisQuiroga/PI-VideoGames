...
var vgameRouter = express.Router();
const axios = require('axios');

//Search all videogames or find by query name
vgameRouter.get('/', async (req, res) => {
...
vgameRouter.get('/:id', async (req, res) => {
	const { id } = req.params;
	try {
		if (!isNaN(id)) {
...
//Delete a videogame
vgameRouter.post('/delete/:name', async (req, res) => {
...
vgameRouter.post('/', async (req, res) => {
